        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewDeadlineTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinalTasks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalTaskId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewQuestions_FinalTasks_FinalTaskId",
                        column: x => x.FinalTaskId,
                        principalTable: "FinalTasks",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_Extensions_ExtensionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Videos_Qualities_QualityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Articles_Resources_ResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_UserToken_UserTokenId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalTaskId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_FinalTasks_FinalTaskId",
                        column: x => x.FinalTaskId,
                        principalTable: "FinalTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "SubmittedFinalTasks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubmitDateUTC = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Mark = table.Column<int>(type: "int", nullable: false),
                    RevievedById = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FinalTaskId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmittedFinalTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubmittedFinalTasks_FinalTasks_FinalTaskId",
                        column: x => x.FinalTaskId,
                        principalTable: "FinalTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubmittedFinalTasks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesMaterials", x => new { x.CourseId, x.MaterialId });
                    table.ForeignKey(
                        name: "FK_CoursesMaterials_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursesMaterials_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingHistory_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    MaterialsCount = table.Column<int>(type: "int", nullable: false),
                    LearnedMaterialsCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "SubmittedReviewQuestions",
                columns: table => new
                {
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    SubmittedFinalTaskId = table.Column<int>(type: "int", nullable: false),
                    Mark = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmittedReviewQuestions", x => new { x.QuestionId, x.SubmittedFinalTaskId });
                    table.ForeignKey(
                        name: "FK_SubmittedReviewQuestions_ReviewQuestions_QuestionId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SubmittedFinalTaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_FinalTaskId",
                table: "Courses",
                column: "FinalTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursesMaterials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewQuestions_FinalTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingHistory_CourseId",
                table: "ShoppingHistory",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingHistory_UserId",
                table: "ShoppingHistory",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmittedFinalTasks_FinalTaskId",
                table: "SubmittedFinalTasks",
                column: "FinalTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmittedFinalTasks_UserId",
                table: "SubmittedFinalTasks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmittedReviewQuestions_SubmittedFinalTaskId",
